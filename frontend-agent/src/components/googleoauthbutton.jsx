...
export const GoogleOAUTHButton = ({ text = "Continue with Google", disabled = false }) => {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`w-full flex items-center justify-center space-x-2 py-2 px-4 rounded-xl font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 ${disabled
          ? 'bg-gray-200 border border-gray-300 text-gray-500 cursor-not-allowed'
          : 'bg-white border border-gray-300 text-gray-700 cursor-pointer hover:bg-gray-50 hover:border-gray-400 focus:ring-blue-500 shadow-sm'
        }`}
    >
