...
const GoogleLoginButton = () => {
  ...
  return (
    <button 
      ...
      className="w-full flex items-center justify-center cursor-pointer space-x-2 bg-gray-50 border border-gray-300 text-gray-700 py-2 px-4 rounded-xl font-medium transition-colors hover:bg-gray-100 hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2"
    >
